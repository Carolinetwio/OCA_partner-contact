...
from odoo.addons.base.tests.test_res_partner import TestPartnerForm
...
TestPartnerForm.test_lang_computation_form_view = test_lang_computation_form_view
TestPartnerForm.test_onchange_parent_sync_user = test_onchange_parent_sync_user
